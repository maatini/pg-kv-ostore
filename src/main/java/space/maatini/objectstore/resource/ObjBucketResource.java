...
public class ObjBucketResource {
        ...
        public Uni<Response> createBucket(@Valid ObjBucketDto.CreateRequest request) {
        ...
        @PermitAll
        public Uni<List<ObjBucketDto.Response>> listBuckets() {
                return objectStoreService.listBuckets()
        ...
        @PermitAll
        public Uni<ObjBucketDto.Response> getBucket(
                        @Parameter(description = "Bucket name") @PathParam("name") String name) {
                return objectStoreService.getBucket(name).map(ObjBucketDto.Response::from);
        }
        ...
        @RolesAllowed({ "admin", "objects-write" })
        public Uni<ObjBucketDto.Response> updateBucket(
                        @Parameter(description = "Bucket name") @PathParam("name") String name,
                        @Valid ObjBucketDto.UpdateRequest request) {
                return objectStoreService.updateBucket(name, request).map(ObjBucketDto.Response::from);
        }
        ...
        public Uni<Response> deleteBucket(
                        @Parameter(description = "Bucket name") @PathParam("name") String name) {
                return objectStoreService.deleteBucket(name).replaceWith(Response.noContent().build());
        }
}
